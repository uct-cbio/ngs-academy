...
<li id="endDate"><b>End date:</b>2022-03-31</li>
</ol>
...
<div class="wrapper">
  ...
  <span class="left scroller-btn"></span>
  	<ul id="scroller" class="nav nav-tabs">
  	  <li class="active"><a data-toggle="tab" href="#home">Introduction stream</a></li>
  	  <li><a data-toggle="tab" href="#menu1">Advanced stream</a></li>
  	</ul>
  <span id="right" class="right scroller-btn"></span>
  </div>
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <h3>Introduction stream</h3>
      <p>
...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="nav-item">
  	...
  	<!-- <li class="nav-item">
   	...
   	<li class="nav-item">
		<a class="nav-link" data-toggle="tab" href="#tabs-5" role="tab">Fri 31 March 2023</a>
	</li> -->
...
<ol>
  <li>1. Get setup working on HPC</li>
  <li>1.1 Confirm participant stream</li>
</ol>                 
</ul></td>
      <td><ul>
...
<ol>
  <li>1.2.1 Writing your own classes<br><a href="#" target="_blank">Lecture & Practical</a></li>
  ...
  <tr>
      ...
      <td>    <ul>
        <li>1.2 Advanced python (cont)</li>
<ol>
  <li>1.2.2 Writing your own classes</li>
