...
<ol>
<li>For the course, access to a high-performance computer will be organised by trainers
</li>
<b>Learning objective:</b> 
<ol>
<li>To be able to implement a bioinformatics workflow using the best practices taught in previous iterations of the course
</li>
...
<div class="tab-content">
  ...
  <tbody>
    <tr>
      <th scope="row">
      <li>1. Bacterial AMR</li> 
          <li>2. Metagenomics for diagnostics</li> 
      <li>3. Variant calling and phylogenetics</li> 
     </th>
      <td>    <ul>
<ol>

 <li><a href="{{ site.url }}uploads/Introduction_to_AI_for_bioinformatics.pdf" target="_blank">1.1 ChatGPT</a></li>

<li>1.2 Julia</li>
<hr>
Datasets
<a href="{{ site.url }}uploads/Meta_1-20240520T162153Z-001.zip" target="_blank">Meta 1</a>
<a href="{{ site.url }}uploads/Meta_2-20240520T162158Z-001.zip" target="_blank">Meta 2</a>
</ol>                 
</ul></td>
      <td><ul>
 ...
 <li> </li>
            ...
            <td><ul>
             <li>Dr George Githinji,John Juma, Phil Ashton</li>
              <li></li>
</ul></td>
    </tr>
  ...
  <tbody>
   ...
   <tr>
      ...
      <li></li>
<ol>
 <li>2.1 Project work</li>
   <li>- get main tools working in isolation (not in workflow)
</li>
   <li>- to join the tools together into workflow
</li>
     <hr>
</ol>                 
</ul></td>
...
<ol>
 <li>3.1 Project work</li>
    <li>-key tasks implemented in workflow</li>
