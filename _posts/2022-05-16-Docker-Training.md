...
<p>Beginner - Intermediate  level  Bioinformaticians working with next-generation sequencing 
</p>
...
<div class="row">
    ...
    <div class="col-sm-10">Introduction to docker and docker commands
    <br> Docker alternatives
...
<ol class="list-unstyled">
 ...
 <li><b>Venue of course:</b> Online  </li>
...
<ol>
  ...
  <tr>
      <th scope="row">Session 2
      <br>
     </th>
      <td>    <ul>
      <li>2. <a href="https://figshare.com/s/d387e001e958296339fe" target="_blank">Introduction to Docker Containers Part 2</a></li>
<ol>
