...
<div class="row">
    <div class="col-sm-2">
        <div><img alt="..." src="{{ site.baseurl }}img/nextflow.png" width="100%" />
            <!-- <p class="small"> Source: CBIO UCT</p> -->
        </div>
    </div>
    <div class="col-sm-2">
        <div><img alt="..." src="{{ site.baseurl }}img/docker.png" width="100%" />
            <!-- <p class="small"> Source: CBIO UCT</p> -->
        </div>
    </div>
    <div class="col-sm-2">
        <div><img alt="..." src="{{ site.baseurl }}img/git.png" width="100%" />
            <!-- <p class="small"> Source: CBIO UCT</p> -->
        </div>
    </div>
    <div class="col-sm-2">
        <div><img alt="..." src="{{ site.baseurl }}img/HPC.jpg" width="100%" />
            <!-- <p class="small"> Source: CBIO UCT</p> -->
        </div>
    </div>
      <div class="col-sm-2">
        <div><img alt="..." src="{{ site.baseurl }}img/snakemake.png" width="100%" />
            <!-- <p class="small"> Source: CBIO UCT</p> -->
        </div>
    </div>
